...
var ICONS = {
  add: async () => (await import("./add-4OCBTQ3X.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-HO75DKHR.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-KIN62HAH.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-AOKCTXHL.js")).appStoreSvg,
  apple: async () => (await import("./apple-FXWUQY7U.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-6ZNWZWRE.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-4JDK5IV5.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-CCRLAQKQ.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-H63CAMNM.js")).arrowTopSvg,
  bank: async () => (await import("./bank-AN2SS4KZ.js")).bankSvg,
  browser: async () => (await import("./browser-FMAG3Y2B.js")).browserSvg,
  card: async () => (await import("./card-W3BPHLGE.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-P6IDJXRS.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-N4Q3VWNB.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-SZWAGI4Q.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-DLRFWP3X.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-YQXTPY7I.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-UG5V2NOR.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-GK5URPQ3.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ZJOIZK5E.js")).clockSvg,
  close: async () => (await import("./close-4F6MND6B.js")).closeSvg,
  compass: async () => (await import("./compass-ZKQLGAU5.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-UZAOATCB.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-X47SBBSE.js")).copySvg,
  cursor: async () => (await import("./cursor-TA7VFF4R.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-Q7LCYVKM.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-XNS3EQNG.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-E6OSM5HX.js")).disconnectSvg,
  discord: async () => (await import("./discord-TPSBKDVQ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-OGRXVC4R.js")).etherscanSvg,
  extension: async () => (await import("./extension-3D6JG37B.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-AJ7WU4KU.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-3W6E5CEX.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-IG5PYDNP.js")).farcasterSvg,
  filters: async () => (await import("./filters-2NXDMTFH.js")).filtersSvg,
  github: async () => (await import("./github-RGXWOFFW.js")).githubSvg,
  google: async () => (await import("./google-N4Z2MODH.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-ESKQVD3V.js")).helpCircleSvg,
  image: async () => (await import("./image-XGA6O5V3.js")).imageSvg,
  id: async () => (await import("./id-ZEIMHMCX.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-67R3ZIOV.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-7SIC6FJU.js")).lightbulbSvg,
  mail: async () => (await import("./mail-WPKALMS6.js")).mailSvg,
  mobile: async () => (await import("./mobile-KG3FTQAV.js")).mobileSvg,
  more: async () => (await import("./more-ZQB2MUY2.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-5R55HNAE.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-EJ3VY6RV.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-5AUA5RMT.js")).offSvg,
  playStore: async () => (await import("./play-store-7QNAPXXU.js")).playStoreSvg,
  plus: async () => (await import("./plus-ZSNWCNCY.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-45ORMORD.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-CWAFNLTV.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-E467MH67.js")).refreshSvg,
  search: async () => (await import("./search-RKS25WT6.js")).searchSvg,
  send: async () => (await import("./send-LSHRXMYZ.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-3ZXJ5LC4.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-3EQ5G2AE.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-5ABLJPPZ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-F4SJCW3B.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-43K4SB4M.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-KWQGCYIP.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-VUIQYF6F.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-A6VE2R56.js")).twitchSvg,
  twitter: async () => (await import("./x-BVRXUNWW.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-WJ4A7UBP.js")).twitterIconSvg,
  verify: async () => (await import("./verify-HPJI7AHX.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-KOMCP2C6.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-47Z24SYW.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-VIS4WXAE.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-VIS4WXAE.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-VIS4WXAE.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-6TATWDIU.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-MLWLRAWI.js")).warningCircleSvg,
  x: async () => (await import("./x-BVRXUNWW.js")).xSvg,
  info: async () => (await import("./info-ARKTNWTC.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-IYUEHOQ4.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-RSIHBAJZ.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LA7G7NXE.js.map
